...
function App() {
  ...
  return (
    <main className="min-h-screen relative flex flex-col items-center">
      <span className='text-md md:text-xl font-semibold mt-24'>¿Qué tanto sabes de...?</span>
      <h1 className="text-3xl md:text-6xl text-center lg:text-8xl font-semibold mt-2">Copa América 2024</h1>
      {questions.length === 0 && (
        <>
